                                        ...
                                        <li><a href="#">Projects</a>
                                            <ul class="careplus-dropdown-menu">
                                               <!--  <li><a href="{{url('/project')}}">Research on the Ageing Population</a>
                                                 ...
                                                 <li><a href="{{url('/project')}}">Clinical Care
                                                 </a>
                                                    <ul class="careplus-dropdown-menu">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="careplus-banner-wrap">
                                        <h1>HEPIQ-C<span>HealthCare Package for the Elderly</span></h1>
                                        <p>HEPIQ-C will ensure a universal healthcare coverage for elderly Nigerians through the provision of comprehensive healthcare, training of healthcare workforce & research and development.</p>
                    ...
                    <div class="careplus-banner-caption">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="careplus-banner-wrap">
                                        <h1><span>Improving Quality</span>of Care for the<span>Aging Population in Nigeria.</span></h1>
                                ...
                                <ul class="row">
                                     <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            ...
                                            <h5>Clinical care</h5>
                                            <p>Establishment of Geriatric Centres at regional level that will be fully funded to train health professionals and build manpower that will cascade downwards.</p>
                                        </div>
                                    </li>
                                    <!-- <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            <i class="icon-medical3"></i>
                                            <h5>Care for the Aged</h5>
                                            <p>Provide preventive, therapeutic and rehabilitative care for the elderly.</p>
                                        </div>
                                    </li> -->
                                    <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            <i class=" icon-tool5"></i>
                                            <h5>Training of Healthcare Practitioners</h5>
                                   ...
                                   <!--  <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            <i class=" icon-tool5"></i>
                                            <h5>Gerontology</h5>
                                            <p>Provide national data for policy implementation and targeted intervention.</p>
                                        </div>
                                    </li> -->
                                    <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            <i class="icon-medical-1"></i>
                                            <h5>Research and Development on Healthy Aging</h5>
                                    ...
                                    <!-- <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            ...
                                            <p>Conduct study on medications, devices, diagnostics products and treatment regimen for the elderly.</p>
                                        </div>
                                    </li> -->
                                    <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            <i class=" icon-ribbon"></i>
                                            <h5>Health-social Support</h5>
                                            <p>Introduction of Community-based support and Home-based care, Provision of free elderly kits to the vulnerable aged, Nutrition and Vaccination; treating the elderly with malnutrition, in collaboration with the relevant sectors, Introduce and promote innovation and use of technology to improve health services of the aged.</p>
                                        </div>
                                    </li>
                                    <!-- <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            <i class=" icon-ribbon"></i>
                                            <h5>Institutional Framework</h5>
                                            <p>Provide framework for tertiary, secondary and primary healthcare facilities.</p>
                                        </div>
                                    </li> -->
                                    <!-- <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            <i class="icon-interface5"></i>
                                            <h5>Community Geriartric Services</h5>
                                            <p>Provide preventive, therapeutic and rehabilitative care for the elderly.</p>
                                        </div>
                                    </li> -->
                                   <!--  <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            ...
                                            <p>Work in collaboration with relevant institutions to ensure quality healthcare for the aged.</p>
                                        </div>
                                    </li> -->
                                    <!-- <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            <i class="icon-old-fashion-briefcase"></i>
                                            <h5>Health Policy Implementation</h5>
                                            <p>Coordinate, monitor, and evaluate health policy implementation.</p>
                                        </div>
                                    </li> -->
                                    <!-- <li class="col-md-3">
                                        <div class="careplus-service-wrap">
                                            <i class="icon-medical-2"></i>
                                            <h5>Training of Healthcare Workforce</h5>
                                            <p>Provide capacity development for the healthcare workforce.</p>
                                        </div>
                                    </li> -->
                                </ul>
                            </div>
      ...
      <!--// Main Section \\-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="careplus-team careplus-team-medium">
                                <ul class="row">
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.html"><img style="width: 400; height: 600" src="images/DSC_6266.JPG" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                                    <h5><a href="team-detail.html">Dr. Saidu Ahmed Dumbulwa</a></h5>
                                                    <span>National Project Coordinator</span>
                                                </div>
                                                <div class="careplus-team-medium-text">
                                                    <h5><a href="team-detail.html">Dr. Saidu Ahmed</a></h5>
                                                    <span>National Project Coordinator</span>
                                                    <p>A medical doctor, public health specialist and national coordinator of Hepiq-C project at the federal ministry of health. </p>
                                    ...
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.html"><img src="images/hafix.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                                    <h5><a href="team-detail.html">Professor Hafiz Khan</a></h5>
                                                    <span>International Project Partner</span>
                                                </div>
                                                <div class="careplus-team-medium-text">
                                                    <h5><a href="team-detail.html">Professor Hafiz Khan</a></h5>
                                                    <span>International Project Partner</span>
                                                    <p>Professor Hafiz T.A. Khan is an international collaborator of HEPIQ-C project in Nigeria. He is currently Professor of Public Health & Statistics at the University of West London and is also an Associate Research Fellow at the Oxford Institute of Population Ageing, etc</p>
                                                    <ul class="careplus-team-social">
                                                        <li><a href="https://www.facebook.com/" class="fa fa-facebook-square"></a></li>
                                                        <li><a href="https://twitter.com/login" class="fa fa-twitter-square"></a></li>
                                                        <li><a href="https://pk.linkedin.com/" class="fa fa-linkedin-square"></a></li>
                                    ...
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.html"><img src="images/DSC_6211.JPG" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                                    <h5><a href="team-detail.html">Abdullahi Abdulaziz</a></h5>
                                                    <span>Permanent Secretary. Federal Ministry of health</span>
                                                </div>
                                                <div class="careplus-team-medium-text">
                                                    <h5><a href="team-detail.html">Abdullahi M. Abdulaziz</a></h5>
                                                    <span>Permanent Secretary. Federal Ministry of health</span>
                                                    <p></p>
                                                    <ul class="careplus-team-social">
                                                        <li><a href="https://www.facebook.com/" class="fa fa-facebook-square"></a></li>
                                    ...
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.html"><img src="images/a6342.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                                    <h5><a href="team-detail.html">Dr. Adebiyi Adebimpe</a></h5>
                                                    <span>Director. Family Health. Federal Ministry of health</span>
                                                </div>
                                                <div class="careplus-team-medium-text">
                                                    <h5><a href="team-detail.html">Dr. Adebiyi Adebimpe</a></h5>
                                                    <span>Director. Family Health. Federal Ministry of health</span>
            ...
            <div class="careplus-main-section tab-color">
                <div class="careplus-tabs-thumb">
                    <div class="careplus-images-thumb-layer"><span><img src="images/DSC_6289.JPG" alt=""></span></div>
                    <div class="careplus-images-thumb-layer"><span><img src="images/DSC_6328.JPG" alt=""></span></div>
                    <div class="careplus-images-thumb-layer"><span><img src="images/DSC_6286.JPG" alt=""></span></div>
                    <div class="careplus-images-thumb-layer"><span><img src="images/DSC_6293.jpg" alt=""></span></div>
                    <div class="careplus-images-thumb-layer"><span><img src="images/DSC_6290.JPG" alt=""></span></div>
                </div>
                ...
                <div class="careplus-department-counter">
                    <ul>
                        <li>
                            ...
                            <h6><span id="word-count1">10</span> Partners</h6>
                        </li>
                        <li>
                            <i class="icon-social10"></i>
                            <h6><span id="word-count2">2,000</span> Trained Health Workers</h6>
                        </li>
                        <li>
                            <i class="icon-old-fashion-briefcase"></i>
                            <h6><span id="word-count3">15</span> Research Publication</h6>
                        </li>
                        <li>
                            <i class=" icon-construction"></i>
                            <h6><span id="word-count4">20,00</span> Centres Supported </h6>
                        </li>
                    </ul>
                </div>                
            </div>
            ...
            <div class="careplus-main-section careplus-gallery-full">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="careplus-fancy-title"><br><br><br>
                                <h2>Our Gallery</h2>
                                <span><small></small><i class="icon-tool5"></i></span>
                            </div>
                            <div class="careplus-gallery-filterable">
                                <ul class="filters-button-group">
                                    ...
                                    <li><a data-filter=".pediatrics" href="javascript:void(0)">Clinical Care</a></li>
                                    <li><a data-filter=".maternity" href="javascript:void(0)">Training of Healthcare Practitioners</a></li>
                                    <li><a data-filter=".skin-care" href="javascript:void(0)">Health-social Support</a></li>
                                    <li><a data-filter=".dental" href="javascript:void(0)">Research and Development on Healthy Aging</a></li>
                                </ul>
                            </div>
                            <div class="careplus-gallery careplus-plane-gallery careplus-plane-gallery-filtrable">
                                <ul class="row">
                                    <li class="col-md-3 element-item maternity skin-care">
                                        <figure>
                                            <a href="images/DSC_6283.JPG"><img src="images/DSC_6283.JPG" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/DSC_6283.JPG" class="fancybox fa fa-arrows"></a>
                                                <h6></h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item skin-care">
                                        <figure>
                                            <a href="images/a37.jpg"><img src="images/a37.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/a37.jpg" class="fancybox fa fa-arrows"></a>
                                                <h6></h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item dental pediatrics">
                                        <figure>
                                            <a href="images/a6342.jpg"><img src="images/a6342.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/a6342.jpg" class="fancybox fa fa-arrows"></a>
                                                <h6></h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item skin-care dental maternity">
                                        <figure>
                                            <a href="images/DSC_6266.JPG"><img src="images/DSC_6266.JPG" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/DSC_6266.JPG" class="fancybox fa fa-arrows"></a>
                                                <h6></h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item pediatrics skin-care">
                                        <figure>
                                            <a href="images/DSC_6414.JPG"><img src="images/DSC_6414.JPG" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/DSC_6414.JPG"></a>
                                                <h6></h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item dental">
                                        <figure>
                                            <a href="images/DSC_6342.JPG"><img src="images/DSC_6342.JPG alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/DSC_6342.JPG" class="fancybox fa fa-arrows"></a>
                                                <h6></h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item pediatrics">
                                        <figure>
                                            <a href="images/DSC_6302.JPG"><img src="images/DSC_6302.JPG" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/DSC_6302.JPG" class="fancybox fa fa-arrows"></a>
                                                <h6></h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item maternity pediatrics">
                                        <figure>
                                            <a href="images/DSC_6328.JPG"><img src="images/DSC_6328.JPG" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/DSC_6328.JPG" class="fancybox fa fa-arrows"></a>
                                                <h6></h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="careplus-blog careplus-blog-modern">
                                <ul class="row">
                                    <li class="col-md-4">
                                        <figure><a href="{{url('#')}}"><img src="images/DSC_6218.JPG" alt=""><span><i class="fa fa-link"></i><small></small></span></a>
                                            <time datetime="2008-02-14 20:00">07 DEC</time>
                                        </figure>
                                        <div class="careplus-blog-modern-text">
                                            <h5><a href="{{url('#')}}">How To Build a Long Distance Care Team</a></h5>
                                            <!-- <p>Lorem ipsum dolor sit amet, constetur ad iscing elit. Sed et elementum nua, eu pla at felis. Etiam tincidunt orci lacus.</p> -->
                                            <a href="#" class="careplus-readmore-btn">Read More <span></span></a>
                                        </div>
                                    </li>
                                    <li class="col-md-4">
                                        <figure><a href="{{url('#')}}"><img src="images/DSC_6262.JPG" alt=""><span><i class="fa fa-link"></i><small></small></span></a>
                                            <time datetime="2008-02-14 20:00">07 DEC</time>
                                        </figure>
                                        <div class="careplus-blog-modern-text">
                                            <h5><a href="{{url('#')}}">How To Build a Long Distance Care Team</a></h5>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="{{url('#')}}"><img src="images/DSC_6283.JPG" alt=""><span><i class="fa fa-link"></i><small></small></span></a>
                                            <time datetime="2008-02-14 20:00">07 DEC</time>
                                        </figure>
                                        <div class="careplus-blog-modern-text">
                                            <h5><a href="{{url('#')}}">How To Build a Long Distance Care Team</a></h5>
                        ...
                        <div class="careplus-partners">
                            <ul>
                              <li>
                                ...
                                <li>
                                    <figure><a href="http://www.nhif.or.ke/" target="_blank"><img src="images/nhif.jpg" alt=""></a> <span>NHIF</span></figure>
                                </li>
                                <li>
