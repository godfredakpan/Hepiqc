...
<head>
  ...
  <body>
    ...
    <div class="careplus-main-wrapper">
		...
		<!--// Main Content \\-->
        <div class="careplus-main-content careplus-content-space">
            <!--// Main Section \\-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="carepluss-contact-us-info">
                                <ul class="row">
                                    <li class="col-md-3">
                                        <div class="carepluss-info">
                                            <h5>Call Us At</h5>
                                            <p>+234 806 - 5769 - 433 </p><br><br>
                                            <p>+234 806 - 5769 - 433 </p>
                                     ...
                                     <li class="col-md-3">
                                        <div class="carepluss-info">
                                            <h5>Mail Us At</h5>
                                            <p><a href="mailto:info@hepiqc.com">info@hepiqc.com</a></p><br><br>
                                              <p><a href="mailto:hello@hepiqc.com">hello@hepiqc.com</a></p>
                                              <p><a href="mailto:aidu@hepiqc.com">saidu@hepiqc.com</a></p>
                                     ...
                                     <li class="col-md-3">
                                        <div class="carepluss-info">
                                            <h5>our Location</h5>
                                            <p>Room 5.1, 3rd Floor,</p> <p>Federal Ministry of Health, FCT Abuja.
                                            </p>
            ...
            <!--// Main Section \\-->
            <div class="careplus-main-section careplus-form-map">
                <div class="careplus-fancy-title">
                    <h2>Contact Us At</h2><span><small></small><i class="icon-tool5"></i></span>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="careplus-map-form">
                                ...
                                <ul>    
                                    <li><input value="Enter Your Name" onblur="if(this.value == '') { this.value ='Enter Your Name'; }" onfocus="if(this.value =='Enter Your Name') { this.value = ''; }" tabindex="0" type="text" name="name"></li>
                                    <li><input value="Enter Your Email" onblur="if(this.value == '') { this.value ='Enter Your Email'; }" onfocus="if(this.value =='Enter Your Email') { this.value = ''; }" tabindex="0" type="email" name="email"></li>
                                     <li class="message-box">
                                        <textarea name="message" placeholder="Enter Message Here" ></textarea>
                                    </li>
                                    <li>
                                        <label><input type="submit" name="submit" value="Send Now"><span></span></label>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAs_m2ywm-bE8z9YM_WmtPaIQNIosN4Dxo&amp;callback=initMap" type="text/javascript"></script>
    ...
    // When the window has finished loading create our google map below
      ...
      function init() {
          ...
          var mapOptions = {
              ...
              center: new google.maps.LatLng(9.0765, 7.3986), // Abuja
          ...
          var marker = new google.maps.Marker({
              position: new google.maps.LatLng(9.0765, 7.3986),
              map: map,
              title: 'Snazzy!'
          });
      }
