                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="careplus-about-post-text">
                                ...
                                <a href="404.html" class="careplus-readmore-btn">Get Appointment <span></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="careplus-team careplus-team-modern">
                            <ul class="row">
                                ...
                                <li class="col-md-3">
                                    <figure><a href="team-detail.html"><img src="extra-images/team-modern-img2.jpg" alt=""><span><i class="fa fa-link"></i><small></small></span></a>
                                        <figcaption>
                                            <ul class="carelus-team-social">
                                                <li><a href="https://www.facebook.com/" class="fa fa-facebook-square"></a></li>
                                                <li><a href="https://twitter.com/login" class="fa fa-twitter-square"></a></li>
