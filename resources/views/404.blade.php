...
<head>
    ...
    <title>CarePlus Error 404</title>
  ...
  <body>
    ...
    <div class="careplus-main-wrapper">
		...
		<!--// Main Content \\-->
        <div class="careplus-main-content error-404-background">
                <span class="careplus-error-transparnt"></span>
            <!--// Main Section \\-->
            <div class="careplus-main-section ">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="careplus-error-page-wrap">
                                <div class="careplus-error-page-text">
                                    <h2>404</h2>
                                    <h3>Sorry! Page doesn't exist</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et element
                                       eu placerat felis. Etiam tincidunt orci lacus, </p>
                                    <div class="clearfix"></div>
                                    <a class="careplus-error-btn" href="{{url('/')}}">>Back To Homepage<span></span></a>
                                </div>
                            </div>
                        </div>
